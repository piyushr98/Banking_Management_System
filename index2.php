...
<body>
		...
		<div class="logo">
			<a href="index.php"><!--<i class="fa fa-inr" aria-hidden="true"></i>-->Corporate <span>bank</span></a><br>
			<a href="index.php"><!--<i class="fa fa-inr" aria-hidden="true"></i>-->Successfully<span>Logged Out!</span></a>
		</div>
		<!-- //Top-Bar -->
