			...
			<div class="container">
				<div class="banner-inner">
					<div class="col-md-5 banner-left">
						<form action="wdl.php" method="post">
						<h3>Withdrawal from Customer's Account</h3>
							<input type="text" name="accno"  placeholder="Accno" required=""/>
							<input type="text" name="balance" placeholder="Balance" required=""/>
							<div class="submit">
								<input type="submit" name="wdl" value="UPDATE">
							</div>
						</form>
						<?php print("$output");?>
					</div>
